...
import { Seesaw } from "../Seesaw/Seesaw";
...
export const Requirements = ({
  ...
  return (
    <>
      ...
      {type === "spinner1" ? (
        <Spinner1 size={size} color1={color1} width={width} />
      ) : null}

      {type === "spinner2" ? (
        <Spinner2 size={size} color1={color1} color2={color2} width={width} />
      ) : null}

      {type === "coin" ? (
        <Coin size={size} color1={color1} width={width} />
      ) : null}
      ...
      {type === "floors" ? (
        <Floors size={size} color1={color1} color2={color2} />
      ) : null}

      {type === "square" ? (
        <Square size={size} color1={color1} color2={color2} />
      ) : null}

      {type === "lines" ? (
        <Lines size={size} color1={color1} width={width} />
      ) : null}
      ...
      {type === "seesaw" ? (
        <Seesaw
          barColor={SeesawBarColor}
          barHeight={SeesawBarHeight}
          barWidth={SeesawBarWidth}
          barBorderRadius={SeesawBarBorderRadius}
          ballColor={SeesawBallColor}
          ballHeight={SeesawBallHeight}
          ballWidth={SeesawBallWidth}
          ballMarginTop={SeesawBallMarginTop}
          ballBottom={SeesawBallBottom}
        />
      ) : null}
    </>
  );
